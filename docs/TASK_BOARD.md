...
| ID | Задача | Статус |
|----|--------|--------|
| BUG-701 | Fix days_active column reference (should be days_active_7d) | TODO |
| Описание: qualification_refresh и activity_counters_update в whale_detector ссылаются на несуществующую колонку w.days_active. Нужно заменить на w.days_active_7d. Ошибка в логах: UndefinedColumn. |
